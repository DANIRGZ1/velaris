...
const CHAMPION_DATABASE: Record<string, ChampionData> = {
  Tristana: {
    ...
    powerSpikes: [
      { level: "Nivel 2", description: "W + E combo. Si el soporte conecta CC, es kill segura." },
      { level: "Nivel 6", description: "La R da burst + distancia. Combo completo E > AA > AA > AA > R para ejecutar." },
      { level: "2 items", description: "Con Kraken + PD el DPS escala masivamente. Empieza a dominar teamfights." },
    ],
    tips: [
      "Tu E pasiva empuja la oleada — ten cuidado con sobreextenderte",
      "Usa W para reposicionarte, no para iniciar (a menos que sea kill 100% segura)",
      "La R puede usarse como peel defensivo contra divers como Zed o Camille",
    ],
  },
  Jinx: {
    ...
    powerSpikes: [
      { level: "Nivel 1", description: "Minigun con Lethal Tempo stackeado tradea muy bien." },
      { level: "Nivel 6", description: "R global para ejecutar o asistir en peleas lejanas." },
      { level: "3 items", description: "Con Kraken + Runaan's + IE, Jinx en teamfight es imparable con la pasiva." },
    ],
    tips: [
      "Empieza con minigun y cambia a cohetes cuando consigas la pasiva (kill/assist)",
      "Las trampas E son increíbles como peel — ponlas a tus pies cuando te divetean",
      "Tu R hace más daño cuanto más lejos viaja — snipes cross-map son legítimos",
    ],
  },
  Aatrox: {
    ...
    powerSpikes: [
      { level: "Nivel 3", description: "Con Q + E + W disponibles, tus trades completos son devastadores." },
      { level: "Nivel 6", description: "La R aumenta tu AD y curación. All-in con ignite/TP ventaja es kill segura." },
      { level: "1 item", description: "Eclipse + Conqueror stackeado = curación absurda en peleas extendidas." },
    ],
    tips: [
      "Guarda tu E para asegurar los sweet spots de la Q, especialmente Q2 y Q3",
      "La W es para asegurar Q3 — combo: Q1 > E+Q2 > W > Q3",
      "Tu mayor debilidad es Cortacuras — si lo compran, juega más por splitpush",
    ],
  },
  Ahri: {
    ...
    powerSpikes: [
      { level: "Nivel 3", description: "E > W > Q combo con Electrocute hace burst enorme." },
      { level: "Nivel 6", description: "R te da 3 dashes. Roaming con R activa es letal para bot/top." },
      { level: "2 items", description: "Luden's + Shadowflame = one-shot a squishies con combo completo." },
    ],
    tips: [
      "Tu Q tiene ida y vuelta — posiciónate para que ambas partes golpeen al enemigo",
      "La E atraviesa minions en la primera unidad que golpea — busca ángulos limpios",
      "Post-6 tu mejor jugada es empujar oleada y roamear con R",
    ],
  },
  LeeSin: {
    ...
    powerSpikes: [
      { level: "Nivel 3", description: "Full clear + gank con Q > Q2 > E > W es tu primera ventana de acción." },
      { level: "Nivel 6", description: "Insec (Q > Ward > W > R > Q2) es una de las mecánicas más impactantes del juego." },
      { level: "1 item", description: "Goredrinker te da sustain para skirmishes en el río y peleas por objetivos." },
    ],
    tips: [
      "Practica el Insec en Practice Tool — es tu herramienta más poderosa",
      "Tu juego tardío es débil — busca cerrar antes de los 30 minutos",
      "Usa W en wards aliados para escapar — siempre lleva Control Wards",
    ],
  },
  Nautilus: {
    ...
    powerSpikes: [
      { level: "Nivel 2", description: "Q + Pasiva auto-attack = CC chain letal con un ADC agresivo." },
      { level: "Nivel 6", description: "La R es point-and-click — imposible de esquivar. Excelente para picks." },
      { level: "Mobility Boots", description: "Con Mobi Boots puedes roamear a mid y crear presión en el mapa." },
    ],
    tips: [
      "Tu pasiva raíza al primer auto — úsala antes de la E para maximizar CC",
      "La Q tiene una hitbox generosa — lánzala a través de minions en ángulo",
      "En teamfights, R al carry enemigo y luego Q para bloquear su escape",
    ],
  },
};
